...
# S3 BUCKET
# //////////////////////////////
resource "aws_s3_bucket" "snowflake-tfremotestate" {
...
resource "aws_s3_bucket_public_access_block" "snowflake-tfremotestate" {
  bucket = aws_s3_bucket.snowflake-tfremotestate.id
